...
$config = array(
  ...
  'example-userpass' => array(
    ...
    'user1:password' => array_merge($azure_ad_attributes_base, array(
      ...
      'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress' => 'user1@ad.example.com',
      ...
      'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name' => 'user1@ad.example.com'
    )),
    'user2:password' => array_merge($azure_ad_attributes_base, array(
      ...
      'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress' => 'user2@ad.example.com',
      'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname' => 'Taro',
      'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname' => 'User2',
      'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name' => 'user2@ad.example.com'
    )),
  ),
);